...
// Use multiple OD.
#define CO_MULTIPLE_OD 1

// Use dynamic variables for allocation.
...
// SDO srv buf.
#define CO_CONFIG_SDO_SRV_BUFFER_SIZE 0

// SDO server timeout.
#define SDO_SERVER_TIMEOUT_MS 0
...
//#define SDO_CLIENT_BLOCK_TRANSFER 1
