...
CockpitWgt::CockpitWgt(QWidget *parent)
    : QWidget(parent)
{
...
CoValuesHolder* CockpitWgt::valsHolder() const
{
    return m_valsHolder;
}

void CockpitWgt::setValsHolder(CoValuesHolder* newValsHolder)
{
    m_valsHolder = newValsHolder;

    setEnabled(m_valsHolder != nullptr);
}

void CockpitWgt::saveCockpit()
{
...
void CockpitWgt::addPlot()
{
    m_actAddPlot_triggered(false);
}

void CockpitWgt::addDial()
{
    m_actAddDial_triggered(false);
}

void CockpitWgt::addSlider()
{
    m_actAddSlider_triggered(false);
}

void CockpitWgt::addBar()
{
    m_actAddBar_triggered(false);
}

void CockpitWgt::addButton()
{
    m_actAddButton_triggered(false);
}

void CockpitWgt::addIndicator()
{
    m_actAddIndicator_triggered(false);
}

void CockpitWgt::m_actAddPlot_triggered(bool checked)
{
    Q_UNUSED(checked)
    ...
    if(m_trendDlg->exec()){
        ...
        plt->setPeriod(static_cast<qreal>(Settings::get()->general.updatePeriod) / 1000);
        ...
        connect(plt, &SDOValuePlot::customContextMenuRequested, this, &CockpitWgt::showPlotsContextMenu);
        if(m_valsHolder->getSLCanOpenNode()) connect(m_valsHolder->getSLCanOpenNode(), &SLCanOpenNode::connected, plt, &SDOValuePlot::clear);

        m_layout->addWidget(plt, m_trendDlg->posRow(), m_trendDlg->posColumn(), m_trendDlg->sizeRows(), m_trendDlg->sizeColumns());
    }
}

void CockpitWgt::m_actEditPlot_triggered(bool checked)
{
    Q_UNUSED(checked)
...
void CockpitWgt::m_actDelPlot_triggered(bool checked)
{
    Q_UNUSED(checked)
...
void CockpitWgt::m_actAddDial_triggered(bool checked)
{
    Q_UNUSED(checked)
    ...
    if(m_dialDlg->exec()){
        ...
        connect(dial, &SDOValueDial::customContextMenuRequested, this, &CockpitWgt::showDialsContextMenu);

        m_layout->addWidget(dial, m_dialDlg->posRow(), m_dialDlg->posColumn(), m_dialDlg->sizeRows(), m_dialDlg->sizeColumns());
    }
}

void CockpitWgt::m_actEditDial_triggered(bool checked)
{
    Q_UNUSED(checked)
...
void CockpitWgt::m_actDelDial_triggered(bool checked)
{
    Q_UNUSED(checked)
...
void CockpitWgt::m_actAddSlider_triggered(bool checked)
{
    Q_UNUSED(checked)
    ...
    if(m_sliderDlg->exec()){
        ...
        connect(slider, &SDOValueSlider::customContextMenuRequested, this, &CockpitWgt::showSlidersContextMenu);

        m_layout->addWidget(slider, m_sliderDlg->posRow(), m_sliderDlg->posColumn(), m_sliderDlg->sizeRows(), m_sliderDlg->sizeColumns());
    }
}

void CockpitWgt::m_actEditSlider_triggered(bool checked)
{
    Q_UNUSED(checked)
...
void CockpitWgt::m_actDelSlider_triggered(bool checked)
{
    Q_UNUSED(checked)
...
void CockpitWgt::m_actAddBar_triggered(bool checked)
{
    Q_UNUSED(checked)
    ...
    if(m_barDlg->exec()){
        ...
        connect(bar, &SDOValueBar::customContextMenuRequested, this, &CockpitWgt::showBarsContextMenu);

        m_layout->addWidget(bar, m_barDlg->posRow(), m_barDlg->posColumn(), m_barDlg->sizeRows(), m_barDlg->sizeColumns());
    }
}

void CockpitWgt::m_actEditBar_triggered(bool checked)
{
    Q_UNUSED(checked)
...
void CockpitWgt::m_actDelBar_triggered(bool checked)
{
    Q_UNUSED(checked)
...
void CockpitWgt::m_actAddButton_triggered(bool checked)
{
    Q_UNUSED(checked)
    ...
    if(m_buttonDlg->exec()){
        ...
        connect(button, &SDOValueButton::customContextMenuRequested, this, &CockpitWgt::showButtonsContextMenu);

        m_layout->addWidget(button, m_buttonDlg->posRow(), m_buttonDlg->posColumn(), m_buttonDlg->sizeRows(), m_buttonDlg->sizeColumns());
    }
}

void CockpitWgt::m_actEditButton_triggered(bool checked)
{
    Q_UNUSED(checked)
...
void CockpitWgt::m_actDelButton_triggered(bool checked)
{
    Q_UNUSED(checked)
...
void CockpitWgt::m_actAddIndicator_triggered(bool checked)
{
    Q_UNUSED(checked)
    ...
    if(m_indicatorDlg->exec()){
        ...
        connect(indicator, &SDOValueIndicator::customContextMenuRequested, this, &CockpitWgt::showIndicatorsContextMenu);
...
void CockpitWgt::m_actEditIndicator_triggered(bool checked)
{
    Q_UNUSED(checked)
...
void CockpitWgt::m_actDelIndicator_triggered(bool checked)
{
    Q_UNUSED(checked)
...
void CockpitWgt::createMenus()
{
    // Actions.
    // Plot.
    m_actAddPlot = new QAction(tr("Добавить график"));
    m_actEditPlot = new QAction(tr("Изменить график"));
    m_actDelPlot = new QAction(tr("Удалить график"));
    // Dial.
    m_actAddDial = new QAction(tr("Добавить показометр"));
    m_actEditDial = new QAction(tr("Изменить показометр"));
    m_actDelDial = new QAction(tr("Удалить показометр"));
    // Slider.
    m_actAddSlider = new QAction(tr("Добавить слайдер"));
    m_actEditSlider = new QAction(tr("Изменить слайдер"));
    m_actDelSlider = new QAction(tr("Удалить слайдер"));
    // Bar.
    m_actAddBar = new QAction(tr("Добавить бар"));
    m_actEditBar = new QAction(tr("Изменить бар"));
    m_actDelBar = new QAction(tr("Удалить бар"));
    // Button.
    m_actAddButton = new QAction(tr("Добавить кнопку"));
    m_actEditButton = new QAction(tr("Изменить кнопку"));
    m_actDelButton = new QAction(tr("Удалить кнопку"));
    // Indicator.
    m_actAddIndicator = new QAction(tr("Добавить индикатор"));
    m_actEditIndicator = new QAction(tr("Изменить индикатор"));
    m_actDelIndicator = new QAction(tr("Удалить индикатор"));

    // Menus.
    m_cockpitMenu = new QMenu();
    m_cockpitMenu->addAction(m_actAddPlot);
    m_cockpitMenu->addAction(m_actAddDial);
    m_cockpitMenu->addAction(m_actAddSlider);
    m_cockpitMenu->addAction(m_actAddBar);
    m_cockpitMenu->addAction(m_actAddButton);
    m_cockpitMenu->addAction(m_actAddIndicator);

    m_plotsMenu = new QMenu();
    m_plotsMenu->addAction(m_actEditPlot);
    m_plotsMenu->addAction(m_actDelPlot);

    m_dialsMenu = new QMenu();
    m_dialsMenu->addAction(m_actEditDial);
    m_dialsMenu->addAction(m_actDelDial);

    m_slidersMenu = new QMenu();
    m_slidersMenu->addAction(m_actEditSlider);
    m_slidersMenu->addAction(m_actDelSlider);

    m_barsMenu = new QMenu();
    m_barsMenu->addAction(m_actEditBar);
    m_barsMenu->addAction(m_actDelBar);

    m_buttonsMenu = new QMenu();
    m_buttonsMenu->addAction(m_actEditButton);
    m_buttonsMenu->addAction(m_actDelButton);

    m_indicatorsMenu = new QMenu();
    m_indicatorsMenu->addAction(m_actEditIndicator);
    m_indicatorsMenu->addAction(m_actDelIndicator);

    // connections.
    connect(m_actAddPlot, &QAction::triggered, this, &CockpitWgt::m_actAddPlot_triggered);
    connect(m_actEditPlot, &QAction::triggered, this, &CockpitWgt::m_actEditPlot_triggered);
    connect(m_actDelPlot, &QAction::triggered, this, &CockpitWgt::m_actDelPlot_triggered);
    connect(m_actAddDial, &QAction::triggered, this, &CockpitWgt::m_actAddDial_triggered);
    connect(m_actEditDial, &QAction::triggered, this, &CockpitWgt::m_actEditDial_triggered);
    connect(m_actDelDial, &QAction::triggered, this, &CockpitWgt::m_actDelDial_triggered);
    connect(m_actAddSlider, &QAction::triggered, this, &CockpitWgt::m_actAddSlider_triggered);
    connect(m_actEditSlider, &QAction::triggered, this, &CockpitWgt::m_actEditSlider_triggered);
    connect(m_actDelSlider, &QAction::triggered, this, &CockpitWgt::m_actDelSlider_triggered);
    connect(m_actAddBar, &QAction::triggered, this, &CockpitWgt::m_actAddBar_triggered);
    connect(m_actEditBar, &QAction::triggered, this, &CockpitWgt::m_actEditBar_triggered);
    connect(m_actDelBar, &QAction::triggered, this, &CockpitWgt::m_actDelBar_triggered);
    connect(m_actAddButton, &QAction::triggered, this, &CockpitWgt::m_actAddButton_triggered);
    connect(m_actEditButton, &QAction::triggered, this, &CockpitWgt::m_actEditButton_triggered);
    connect(m_actDelButton, &QAction::triggered, this, &CockpitWgt::m_actDelButton_triggered);
    connect(m_actAddIndicator, &QAction::triggered, this, &CockpitWgt::m_actAddIndicator_triggered);
    connect(m_actEditIndicator, &QAction::triggered, this, &CockpitWgt::m_actEditIndicator_triggered);
    connect(m_actDelIndicator, &QAction::triggered, this, &CockpitWgt::m_actDelIndicator_triggered);

    // widget context menu.
    addAction(m_actAddPlot);
    addAction(m_actAddDial);
    addAction(m_actAddSlider);
    addAction(m_actAddBar);
    addAction(m_actAddButton);
    addAction(m_actAddIndicator);

    // Setup.
    setContextMenuPolicy(Qt::ActionsContextMenu);
}

void CockpitWgt::destroyMenus()
{
    removeAction(m_actAddPlot);
    removeAction(m_actAddDial);
    removeAction(m_actAddSlider);
    removeAction(m_actAddBar);
    removeAction(m_actAddButton);
    removeAction(m_actAddIndicator);

    m_indicatorsMenu->removeAction(m_actDelIndicator);
    m_indicatorsMenu->removeAction(m_actEditIndicator);
    delete m_indicatorsMenu;

    m_buttonsMenu->removeAction(m_actDelButton);
    m_buttonsMenu->removeAction(m_actEditButton);
    delete m_buttonsMenu;

    m_barsMenu->removeAction(m_actDelBar);
    m_barsMenu->removeAction(m_actEditBar);
    delete m_barsMenu;

    m_slidersMenu->removeAction(m_actDelSlider);
    m_slidersMenu->removeAction(m_actEditSlider);
    delete m_slidersMenu;

    m_dialsMenu->removeAction(m_actDelDial);
    m_dialsMenu->removeAction(m_actEditDial);
    delete m_dialsMenu;

    m_plotsMenu->removeAction(m_actDelPlot);
    m_plotsMenu->removeAction(m_actEditPlot);
    delete m_plotsMenu;

    m_cockpitMenu->removeAction(m_actAddPlot);
    m_cockpitMenu->removeAction(m_actAddDial);
    m_cockpitMenu->removeAction(m_actAddSlider);
    m_cockpitMenu->removeAction(m_actAddBar);
    m_cockpitMenu->removeAction(m_actAddButton);
    m_cockpitMenu->removeAction(m_actAddIndicator);
    delete m_cockpitMenu;

    //delete m_cockpitMenu;
    delete m_actAddPlot;
    delete m_actAddDial;
    delete m_actAddSlider;
    delete m_actAddBar;
    delete m_actAddButton;
    delete m_actAddIndicator;
    //delete m_plotsMenu;
    delete m_actEditPlot;
    delete m_actDelPlot;
    //delete m_dialsMenu;
    delete m_actEditDial;
    delete m_actDelDial;
    //delete m_slidersMenu;
    delete m_actEditSlider;
    delete m_actDelSlider;
    //delete m_barsMenu;
    delete m_actEditBar;
    delete m_actDelBar;
    //delete m_buttonsMenu;
    delete m_actEditButton;
    delete m_actDelButton;
    //delete m_indicatorsMenu;
    delete m_actEditIndicator;
    delete m_actDelIndicator;
}

void CockpitWgt::applySettings()
{
    Settings* s = Settings::get();

    m_signalCurveEditDlg->setNodeId(s->co.nodeId);
    m_dialDlg->setNodeId(s->co.nodeId);
    m_sliderDlg->setNodeId(s->co.nodeId);
    m_barDlg->setNodeId(s->co.nodeId);
    m_buttonDlg->setNodeId(s->co.nodeId);
    m_indicatorDlg->setNodeId(s->co.nodeId);
}

void CockpitWgt::clearCockpitWidgets()
{
...
CockpitSerializer::CockpitWidgets CockpitWgt::collectCockpitWidgets()
{
...
void CockpitWgt::appendCockpitWidgets(const CockpitSerializer::CockpitWidgets& widgets)
{
    for(auto& p: widgets){
        QWidget* w = p.first;
        ...
        if(auto wgt = qobject_cast<SDOValuePlot*>(w)){
            connect(wgt, &SDOValueBar::customContextMenuRequested, this, &CockpitWgt::showPlotsContextMenu);
            wgt->setPeriod(static_cast<qreal>(Settings::get()->general.updatePeriod) / 1000);
        }else if(auto wgt = qobject_cast<SDOValueDial*>(w)){
            connect(wgt, &SDOValueBar::customContextMenuRequested, this, &CockpitWgt::showDialsContextMenu);
        }else if(auto wgt = qobject_cast<SDOValueSlider*>(w)){
            connect(wgt, &SDOValueBar::customContextMenuRequested, this, &CockpitWgt::showSlidersContextMenu);
        }else if(auto wgt = qobject_cast<SDOValueBar*>(w)){
            connect(wgt, &SDOValueBar::customContextMenuRequested, this, &CockpitWgt::showBarsContextMenu);
        }else if(auto wgt = qobject_cast<SDOValueButton*>(w)){
            connect(wgt, &SDOValueBar::customContextMenuRequested, this, &CockpitWgt::showButtonsContextMenu);
        }else if(auto wgt = qobject_cast<SDOValueIndicator*>(w)){
            connect(wgt, &SDOValueBar::customContextMenuRequested, this, &CockpitWgt::showIndicatorsContextMenu);
        }
...
void CockpitWgt::showPlotsContextMenu(const QPoint& pos)
{
...
void CockpitWgt::showDialsContextMenu(const QPoint& pos)
{
...
void CockpitWgt::showSlidersContextMenu(const QPoint& pos)
{
...
void CockpitWgt::showBarsContextMenu(const QPoint& pos)
{
...
void CockpitWgt::showButtonsContextMenu(const QPoint& pos)
{
...
void CockpitWgt::showIndicatorsContextMenu(const QPoint& pos)
{
